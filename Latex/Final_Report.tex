...
\begin{figure}[t]
    ...
    \subcaptionbox{Manual Color Map For Sample 1\label{subfig:Manual_Color_Map_OP1}}{
...
\begin{figure}[b]
    ...
    \subcaptionbox{Manual Color Map For Sample 2\label{subfig:Manual_Color_Map_OP2}}{
